...
'''
Analysis of Barozai's miRNAs in our samples. Counts hits by
bowtie2 and summarises results per carrot line and gives a
total overview (Do all samples contain the 17 miRNAs?).

input = .sam files by alignments of each sample (remaining 
 sequences between 15 and 30)
output = summary of Barozai's miRNAs found in our sample,
...
SAM_FILES = ["./Mapping_results/sample_", "_pakibase.sam"]
OUTPUT = "Report/miRNAs_from_Barozai.txt"
